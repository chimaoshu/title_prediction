...
for row in _data:
    ...
    # if click_times < 200:
    #     a_row_of_info_y.append(1)

    # elif click_times < 400:
    #     a_row_of_info_y.append(2)

    # elif click_times < 600:
    #     a_row_of_info_y.append(3)

    # elif click_times < 800:
    #     a_row_of_info_y.append(4)

    # elif click_times < 1000:
    #     a_row_of_info_y.append(5)

    # else:
    #     a_row_of_info_y.append(6)
...
X_train, X_test, y_train, y_test = train_test_split(iris_X, iris_y, test_size=0.20, random_state=None)
...
bagging = BaggingClassifier(
    ...
    max_samples=0.4).fit(X_train, y_train.ravel())
